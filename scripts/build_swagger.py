...
<div class="notice">
  ...
  <strong>Cette page est servie hors de la gateway</strong>, sur un port distinct : le sandbox
  n'expose que les 33 routes du contrat, et une route de documentation le rendrait discernable de
  la plateforme réelle. C'est pourquoi <code>http://localhost:8080/swagger.html</code> répond
  <code>404</code>.
